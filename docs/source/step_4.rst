...
*For TurtleBot, run the following command*
    ...
    ``roslaunch mowito_turtlebot run_mw_navigation.launch map_name:=mymap``

*For HuskyBot, run the following command*

    ``roslaunch mowito_huskybot run_mw_navigation.launch map_name:=mymap``
...
*For TurtleBot, run the following command*
    ...
    ``roslaunch mowito_turtlebot start_rviz.launch``

*For HuskyBot, run the following command*

    ``roslaunch mowito_huskybot start_rviz.launch``

**Step 4 : in the rviz, click on the second top panel, click on the nav goal option, and click on the displayed map to give goal to the robot**

**Step 5 : look at the output on the rviz, the path planned and the motion of the robot**

---------------------------
Navigation for realtime Bot
---------------------------
In construction
...
**A. Selecting the type of (Global) Planner  before launching the stack**
    ...
    *For TurtleBot run the following command*
      ...
      ``roslaunch mowito_turlebot sim_mw_navigation.launch``

    *For HuskyBot run the following command*
          
      ``roslaunch mowito_huskybot sim_mw_navigation.launch``
